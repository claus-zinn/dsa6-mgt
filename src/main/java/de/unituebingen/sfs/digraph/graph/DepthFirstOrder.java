...
/******************************************************************************
 * Compilation:  javac graph.DepthFirstOrder.java
 * Execution:    java graph.DepthFirstOrder filename.txt
 * Dependencies: graph.Digraph.java util.Queue.java util.Stack.java util.StdOut.java
 ...
 * Runs in O(E + V) time.
 * <p>
 * % java graph.DepthFirstOrder tinyDAG.txt
 * v  pre post
 * --------------
 * 0    0    8
 * 1    3    2
...
/**
 * The <tt>graph.DepthFirstOrder</tt> class represents a data type for
...
public class DepthFirstOrder {
    ...
    /**
     * Unit tests the <tt>graph.DepthFirstOrder</tt> data type.
     */
