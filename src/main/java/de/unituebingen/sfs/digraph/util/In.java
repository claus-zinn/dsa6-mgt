package util; /******************************************************************************
 *  Compilation:  javac util.In.java
 *  Execution:    java util.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
   ...
   /**
     ...
     * @deprecated Replaced by <tt>new util.In(filename)</tt>.{@link #readAllInts()}.
     */
   ...
   /**
     ...
     * @deprecated Replaced by <tt>new util.In(filename)</tt>.{@link #readAllDoubles()}.
     */
   ...
   /**
     ...
     * @deprecated Replaced by <tt>new util.In(filename)</tt>.{@link #readAllStrings()}.
     */
   ...
   /**
     * Unit tests the <tt>util.In</tt> data type.
     */
