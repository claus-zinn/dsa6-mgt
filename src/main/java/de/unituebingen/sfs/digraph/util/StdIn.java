...
/**
 *  The <tt>util.StdIn</tt> class provides static methods for reading strings
 ...
 *  <pre>
 *  String[] words = util.StdIn.readAllString();
 *  </pre>
 *  <p>
 ...
 *       and sockets.
 *  <li> {@code util.StdIn} uses whitespace as the delimiter between tokens.
 ...
 *  If the input begins with the optional byte-order mask, <tt>util.StdIn</tt>
